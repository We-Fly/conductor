...
FixedPoint::FixedPoint(rclcpp::Node::SharedPtr node, const std::string &topic, fixed_point::Point center, const pid_controller::PidParams &params_x, const pid_controller::PidParams &params_y)
    : node_(node), center_(center), output_bound_(params_x.output_bound, params_y.output_bound), 
